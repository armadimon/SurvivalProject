...
| 게임 플레이 | 플레이어 / 배틀 |
|---|---|
|![image](https://github.com/user-attachments/assets/3beb7d20-bdd4-43db-a473-34f7409f7eae)|![3D 서바이벌 게임 - 프레임 3](https://github.com/user-attachments/assets/f1b93c76-5fd8-4721-83ea-5c7c1986f1bf)|

| 생존 관리 시스템 | 빌드 시스템 |
|---|---|
|![3D 서바이벌 게임 - 프레임 2](https://github.com/user-attachments/assets/7ca99a9d-7651-4719-98c5-968098d92eea)|![3D 서바이벌 게임 - 프레임 1](https://github.com/user-attachments/assets/42aa880e-7a7c-425d-ba21-4b5e5d5abbc1)|

## 🎮 주요 기능
### 자원 수집 및 가공
- 플레이어가 자원을 찾아 수집하고, 이를 가공하여 생존에 필요한 아이템을 제작할 수 있습니다.
### 식사와 수분 관리 
- 플레이어는 식사와 수분을 관리해야 하며, 굶주림과 갈증을 방지해야 합니다.
### 건축 및 생존 기지 구축
- 플레이어가 기지를 건설하여 안전한 거점을 확보할 수 있습니다.
### 적과의 전투
- 다양한 적과의 전투를 구현하고, 적의 AI를 통해 플레이어에게 도전적인 전투 환경을 제공합니다.
### 생존 관리 시스템
- 플레이어의 체력, 스태미너 등 생존에 필요한 상태를 관리합니다.
### 자원 리스폰
- 자원이 일정 시간이 지나면 다시 생성되는 시스템을 구현하여 게임의 지속 가능성을 유지합니다.

## 🚀 추가한 기능
### 🌦️ 날씨와 환경 요소
- 비가 올 때 플레이어의 수분을 해결합니다.
- 보스가 소환될 경우 날씨가 "비" 상태로 변경됩니다.
### 🏗️ 고급 건축 시스템
- 다양한 건축 옵션과 고급 건축 요소를 추가하여 기지 건설을 더욱 다양하게 구성할 수 있습니다.
- 작업대, 캠프파이어, 기둥, 벽 등을 활용한 기지 건설이 가능합니다.
- 건물의 내구도를 적용하여 현실감을 높였습니다.
### 🐾 다양한 적 종류
- **적 추가**: 닭, 개, 호랑이, 사슴, 곰, 보스 곰을 추가하였습니다.
 
### 🤖 고급 AI 시스템
- 적이 가까이 접근하면 플레이어를 공격하며, 멀어지면 공격을 멈추고 이동합니다.
